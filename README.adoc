...
// Shields.
image::https://img.shields.io/badge/License-GPLv3-blue.svg[link="https://www.gnu.org/licenses/gpl-3.0"]
...
//
The guard specification format follows the one used by Erlang, the only difference being that guard functions (_e.g._ `is_pid/1`)




=== The SHML__nf__ syntax
